...
|--------|-------------|---------------|
| Cache Poisoning | Injects fake records into a resolver's cache, redirecting users | [attacks/dns-attacks/cache-poisoning.md](../../attacks/dns-attacks/cache-poisoning.md) |
| DNS Amplification | Uses open resolvers to flood a victim with traffic | [attacks/dns-attacks/dns-amplification.md](../../attacks/dns-attacks/dns-amplification.md) |
| DNS Tunneling | Hides data or C2 traffic inside DNS queries | [attacks/dns-attacks/dns-tunneling.md](../../attacks/dns-attacks/dns-tunneling.md) |
